...
from thermal_tracker.core.config import ClickSelectionConfig
...
from thermal_tracker.core.stages.target_selection.local_patch import LocalPatch


class ClickTargetSelector(BaseTargetSelector):
    ...
    def _expand_selection(self, patch: LocalPatch, selection: TargetSelectorResult) -> TargetSelectorResult:
    ...
    def _select_contrast_component(
        ...
        return TargetSelectorResult(bbox=result_bbox, confidence=confidence, polarity=polarity)
    ...
    def _compact_selection_for_elongated_component(
        ...
        return TargetSelectorResult(bbox=compact_bbox, confidence=0.45, polarity=polarity)
    ...
    def _fallback(
        ...
        return TargetSelectorResult(bbox=bbox, confidence=0.05, polarity="fallback")
