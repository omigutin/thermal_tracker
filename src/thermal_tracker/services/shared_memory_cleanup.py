...
from ..connections.shared_memory import DEFAULT_SHARED_MEMORY_PREFIX
from ..connections.shared_memory.protocol import frame_buffer_name, json_buffer_name
...
def main() -> None:
    """Точка входа `python -m thermal_tracker.services.shared_memory_cleanup`."""
