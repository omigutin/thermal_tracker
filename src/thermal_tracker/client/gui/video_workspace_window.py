...
from thermal_tracker.core.config import AVAILABLE_PRESETS, PROJECT_ROOT, build_preset, get_preset_presentation
from thermal_tracker.core.errors import VideoOpenError
...
GUI_STATE_CONFIG_PATH = PROJECT_ROOT / "configs" / "desktop_client_state.json"
GUI_STATE_VERSION = 1
...
class TrackingPlayerWindow:
    ...
    def _save_gui_state(self) -> None:
        """Записывает настройки окна в корневой каталог configs."""

        try:
            GUI_STATE_CONFIG_PATH.parent.mkdir(parents=True, exist_ok=True)
