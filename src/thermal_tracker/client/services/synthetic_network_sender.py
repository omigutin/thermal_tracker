...
from thermal_tracker.core.connections.shared_memory import DEFAULT_FRAME_HEIGHT, DEFAULT_FRAME_WIDTH
...
def main() -> None:
    """Точка входа `python -m thermal_tracker.client.services.synthetic_network_sender`."""
